...
- 1.1. Cuenta AWS y Free Tier
  - Crea una cuenta en AWS y activa el Free Tier para experimentar sin costo durante 12 meses. [Amazon Web Services, Inc](https://aws.amazon.com/es/training/learn-about/serverless/)
  - Revisa el AWS Shared Responsibility Model para entender la seguridad de tu infraestructura. [AWS Documentation](https://docs.aws.amazon.com/pdfs/whitepapers/latest/microservices-on-aws/microservices-on-aws.pdf)
