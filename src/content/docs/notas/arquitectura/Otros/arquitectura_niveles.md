...
[img](public/n-tier-architecture.webp)
...
- __Capa de presentación:__ Maneja las interacciones del usuario con la aplicación.
- __Capa de lógica de negocio:__ Acepta los datos de la capa de aplicación, los valida según la lógica de negocio y los pasa a la capa de datos.
- __Capa de acceso a los datos:__ Recibe los datos de la capa de negocio y realiza las operaciones necesarias en la base de datos.

### Arquitectura de 2 niveles
- __Capa de presentación:__ se ejecuta en el cliente y se comunica con un almacén de datos. 
